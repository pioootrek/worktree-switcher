...
try {
  ...
  assert.deepEqual(historicalReply.historicalImport, { sourceAuthor: historical.originalPayload.author, sourceDate: historical.originalPayload.date, sourceDateStatus: "valid" });
